...
function buildNewList(item, index) {
	...
	if( item.wikiGovernmentRequester ) {
		govItem = "<a class='link' href=" + item.wikiGovernmentRequester + ' target="_blank">' + item.GovernmentRequester + "</a>";
	}
	...
	if( item.wikiCompany ) {
		companyItem = "<a class='link' href=" + item.wikiCompany + ' target="_blank">' + item.Company + "</a>";
	}
